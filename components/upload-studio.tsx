...
export function UploadStudio() {
  ...
  const publish = async (event: FormEvent) => {
    ...
    try {
      if (uploadId) {
        const response = await fetch("/api/uploads", { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id: uploadId, title, description, category, visibility }) });
